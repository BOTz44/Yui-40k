 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 YUI  - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 YUI  - BOT..."},
	]
    },{
	...
	rows: [
	    ...
	    {title: `♣ ∫ » Script «`, rowId: ".donasi", description: '✧ Script Bot Wa ini'},
...
let tek = `
 ...
 ┌──〔  𝐃𝐀𝐓𝐀𝐁𝐀𝐒𝐄  〕───⬣ 
 │⬡ Aktif selama ${mpt}
 │⬡ Total Pengguna : *${Object.keys(global.db.data.users).length}* Pengguna
...
*/
	...
	return conn.sendButton(m.chat, bottime, text, `${imgr + 'Menu'}`, [["REFERAL", _p + "ref"], ["DONASI", _p + "donasi"], ["OWNER", _p + "owner"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "https://linktr.ee/angga_ozmy",",
                mediaType: "VIDEO",
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By YUI  TEAM',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://chat.whatsapp.com/JU66z1fFSH2H19XesIkGTT'
                    }
                },
                {
                    urlButton: {
