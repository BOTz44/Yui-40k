...
const sections = [
   {
    ...
    title: `✃ INFO`,
	rows: [
	    {title: "💻INFO BOT", rowId: '.info', description: 'Info OHLX BOT' },
	    {title: "🗃️MENU", rowId: '.menu', description: 'Back to menu' },
	{title: "👤OWNER", rowId: '.owner', description: 'Owner OHLX BOT' },
	{title: "💰SEWA BOT", rowId: '.sewa', description: 'Sewa OHLX BOT' },
	]
    },
]
